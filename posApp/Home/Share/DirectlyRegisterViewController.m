...
@interface DirectlyRegisterViewController ()
{
    NSString *phone;
    NSString *yzm;
    NSString *password;
...
@implementation DirectlyRegisterViewController
...
- (void)viewDidLoad {
    ...
    [self.promptView.layer setCornerRadius:5];
...
- (IBAction)registerAccount:(UIButton *)sender {
    ...
    NSDictionary *dic = @{@"service":@"Member.Register",@"phone":phone,@"utoken":UTOKEN,@"yzm":yzm,@"password":password};
